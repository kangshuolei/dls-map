 ...
 * @LastEditTime: 2024-09-29 15:50:10
-->
<template>
  <div class="appMain">
    <dls-map
    ...
    />
    <div class="operation">
      <el-button @click="handleBufferArea" type="primary">绘制缓冲区</el-button>
    </div>
  </div>
</template>

<script lang="ts" setup>
import { CesiumBufferAnalyze, DlsMap } from 'dls-map';
...
//绘制缓冲区
const handleBufferArea = () => {
  let buffer = new CesiumBufferAnalyze(dataM.viewer, 100000);
  buffer.polyBuffer();
};
